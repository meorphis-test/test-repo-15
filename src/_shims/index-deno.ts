...
export function fileFromPath() {
  throw new Error(
    'The `fileFromPath` function is only supported in Node. See the README for more details: https://www.github.com/meorphis-test/meorphis-test-29-to1nbv-node#file-uploads',
  );
}
